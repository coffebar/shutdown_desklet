...
ShutdownDesklet.prototype = {
	...
	_init: function(metadata){
        ...
        this._container.set_style('background-color: #CAEDAA;padding:1px;');

        this._str = new St.Label();
        this._str.set_text("Shutdown");
		this._btn = new St.Button();
		this._lastClickedDate = new Date() - 10000;
	...
	_clicked: function(){		
		...
		if(clickedDate - this._lastClickedDate > 250){
			this._lastClickedDate = clickedDate;
			return;
		}
